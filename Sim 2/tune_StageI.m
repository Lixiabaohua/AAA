...
diff1 = 1;  coeff1 =Pcoeff1;
 ...
 nalpha1 = sqrt(abs(coefind1'*W*coefind1))/sqrt(mean(temp1.^2));
 nalpha2 = sqrt(abs(coefind2'*W*coefind2))/sqrt(mean(temp2.^2));
 nalpha3 = sqrt(abs(coefind3'*W*coefind3))/sqrt(mean(temp3.^2));
 nalpha4 = sqrt(abs(coefind4'*W*coefind4))/sqrt(mean(temp4.^2));
 ...
 constalp4=  deriveSCAD(k1^(-3/2)*nalpha4,lam)/nalpha4; 
 ...
 a1 = sqrt(mean(iterPalp1.^2));
 a2 = sqrt(mean(iterPalp2.^2));
 a3 = sqrt(mean(iterPalp3.^2));
 a4 = sqrt(mean(iterPalp4.^2));
 %standardized
