function [halp,hbeta,res,coeff1,coeff2,stdpara] =Spest( I1,kC, kA, m1, m, sampleX, u, y,delta)
...
T=length(y);
b1 = rspline(sampleX(1:T,1),sampleX(:,1), m1,kA);   
